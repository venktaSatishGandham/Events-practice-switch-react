...
class Events extends Component {
  ...
  onClickEventItemImage = registrationStatus => {
    console.log(registrationStatus)
    this.setState({isRegister: registrationStatus})
  }
    ...
    return (
      <div className="events-container">
        <div className="events-left-container">
          <h1 className="events-left-container-heading">Events</h1>
          <ul className="event-items">
            {eventsList.map(each => (
              <EventItem
                key={each.id}
                onChangeLeftContainer={this.onClickEventItemImage}
                eachEventItem={each}
              />
            ))}
          </ul>
        ...
        <div className="events-right-container">
          <ActiveEventRegistrationDetails isChecking={isRegister} />
        </div>
      </div>
    )
  }
